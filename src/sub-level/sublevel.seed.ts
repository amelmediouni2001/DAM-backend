...
export class SublevelSeeder {
    ...
    const level2Subs = [
  {
    levelId: level2._id,
    index: 1,
    title: 'Melody Warm-Up',
    description:
      'Let’s start nice and easy! Try these notes: Sol – La – Sol. You can do it!',
    difficulty: 1,
    notes: ['sol', 'la', 'sol'],
    maxStars: 3,
    requiredStars: 12,
    trackName: 'Level 2 - Warmup',
  },
  {
    levelId: level2._id,
    index: 2,
    title: 'Rising Notes',
    description:
      'Great job! Now let’s make the melody go up, up, up! Play Do – Fa – La – Do.',
    difficulty: 2,
    notes: ['do', 'fa', 'la', 'do'],
    maxStars: 3,
    requiredStars: 15,
    trackName: 'Level 2 - Rise',
  },
  {
    levelId: level2._id,
    index: 3,
    title: 'Flowing Melody',
    description:
      'Ready for something fun? These notes flow like a little music river! Try Si – Sol – Fa – Ré.',
    difficulty: 3,
    notes: ['si', 'sol', 'fa', 'ré'],
    maxStars: 3,
    requiredStars: 18,
    trackName: 'Level 2 - Flow',
  },
  {
    levelId: level2._id,
    index: 4,
    title: 'Extended Phrase',
    description:
      'Wow, you’re doing amazing! Here’s a longer melody to try: Ré – Mi – Fa – Sol – La.',
    difficulty: 4,
    notes: ['ré', 'mi', 'fa', 'sol', 'la'],
    maxStars: 3,
    requiredStars: 21,
    trackName: 'Level 2 - Phrase',
  },
  {
    levelId: level2._id,
    index: 5,
    title: 'Full Sequence',
    description:
      'Time for the big finish! Play the whole melody: Do – Do – Sol – Sol – La – La – Sol. You’re a star!',
    difficulty: 5,
    notes: ['do', 'do', 'sol', 'sol', 'la', 'la', 'sol'],
    maxStars: 3,
    requiredStars: 24,
    trackName: 'Level 2 - Full Sequence',
  },
];
