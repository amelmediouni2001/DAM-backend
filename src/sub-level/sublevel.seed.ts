...
export class SublevelSeeder {
    ...
    const level2Subs = [
  {
    ...
    difficulty: 1,
    notes: ['ré', 'fa', 'la'],
    noteDurations: ['short', 'short', 'long'],
    maxStars: 3,
    requiredStars: 12,
  ...
  },
  {
    ...
    difficulty: 3,
    notes: ['ré', 'fa', 'la'],
    noteDurations: ['short', 'short', 'short'],
    maxStars: 3,
    requiredStars: 18,
  ...
  },
  {
    ...
    difficulty: 4,
    notes: ['la#', 'la', 'sol#', 'fa'],
    noteDurations: ['short', 'short', 'short', 'short'],
    maxStars: 3,
    requiredStars: 21,
  ...
  },
  {
    ...
    difficulty: 5,
    notes: ['ré', 'fa', 'la', 'sol#', 'fa', 'ré', 'ré', 'fa', 'la', 'la#', 'la', 'sol#', 'fa', 'ré'],
    noteDurations: ['short', 'short', 'long', 'short', 'short', 'long', 'short', 'short', 'short', 'short', 'short', 'short', 'short', 'long'],
    maxStars: 3,
    requiredStars: 24,
